...
public class CheckpointRestoreUtils {

    private static final Logger LOG = LoggerFactory.getLogger(CheckpointRestoreUtils.class);

    public static void run(@Nonnull StreamGraph streamGraph, @Nullable String externalCheckpoint) throws Exception {
    ...
    private static int getSlotNum(JobGraph jobGraph) {
        ...
        for (JobVertex jobVertex : jobGraph.getVertices()) {
            SlotSharingGroupId slotSharingGroupId = jobVertex.getSlotSharingGroup().getSlotSharingGroupId();
